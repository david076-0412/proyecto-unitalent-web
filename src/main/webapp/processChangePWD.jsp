...
<%
	...
	try {
		...
		ResultSet rs = st.executeQuery("select * from docentes where clave= '"+ OldPassword + "'");
		if (rs.next()) {			
		...
		if (pass.equals(OldPassword)) {
			st = con.createStatement();
			int i = st.executeUpdate("update docentes set clave='"+ Newpass + "'");
			
			
			
		
			pageContext.forward("/docentes?tipo=forgotPassword");
