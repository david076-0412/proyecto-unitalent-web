				    ...
				    <div class="col-md-12">
					   ...
					   <table id="example" class="table table-striped table-hover" style="width:100%">
						  ...
						  <tbody>
							 ...
							 <th><c:out value="${material.name}" /></th> 
							 
							 
							 <th><c:out value="${material.titulo}" /></th>
							 
							 <th><c:out value="${material.descripcion}" /></th>
							 
							 <th><c:out value="${material.nivel}" /></th>
							 <th><c:out value="${material.materia}" /></th> 
							  
							 <th><c:out value="${material.tema}" /></th> 
							 
							 <th>
							 <a href="materialalumnosver?id=${material.id}" class="edit">
