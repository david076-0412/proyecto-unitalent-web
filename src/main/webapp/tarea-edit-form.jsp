		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
				 ...
				 <div class="xp-breadcrumbbar text-center">
					...
					<ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/listarclase">Clases</a></li>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form action="updatetarea" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Materia</label> <input type="text"
						value="<c:out value='${tarea.materia}' />" class="form-control"
          ...
          <p><label>Seleccionar Materia</label>
          ...
          <div class="form-group">
            <label>Fecha de Entrega</label> 
					...
					<input type="date"
						...
						value="<c:out value='${tarea.fechade}' />" 
          ...
          <div class="form-group">
            <label>Hora</label> 
					...
					<input type="time"
						class="form-control"
						id="hora" name="hora" value="<c:out value='${tarea.hora}' />" required="required">
          </div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="eliminararchivotarea" enctype="MULTIPART/FORM-DATA" method="post">
      ...
      <div class="modal-body">
        ...
        <img src="taimagen/<c:out value='${tarea.archivo}' />" width="340" height="220"/>
        
		 
		 
		<p> 
		<a href="eliminardatotarea?archivo=<c:out value='${tarea.archivo}' />" class="btn btn-sucess">
