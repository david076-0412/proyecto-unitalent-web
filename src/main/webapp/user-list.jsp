   ...
   <!-------sidebar--design- close----------->
      ...
      <div id="content">
		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
				 ...
				 <div class="xp-breadcrumbbar text-center">
					...
					<ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="list?name=<c:out value='${sessionScope.docentes.nombre} ${sessionScope.docentes.apellido}' />">Alumnos</a></li>
					   ...
					   <div class="table-title">
					     <div class="row">
							 ...
							 <div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
							  ...
							  <a href="user-form.jsp" class="btn btn-success">
       ...
       <thead>
				...
				<tbody>
					<!--   for (Todo todo: todos) {  -->
					<c:forEach var="alumno" items="${listUser}">
						...
						<tr>
							...
							<td><a href="edit?id=${alumno.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								
							
							
							<td>
							
							<a href="delete?id=${alumno.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
