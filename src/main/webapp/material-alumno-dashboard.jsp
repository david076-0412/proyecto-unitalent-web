		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
				 ...
				 <div class="xp-breadcrumbbar text-center">
					...
					<ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="listarcursosalumnos?name=<c:out value='${sessionScope.alumnos.name} ${sessionScope.alumnos.apellido}' />">Cursos</a></li>
					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Lista de Cursos</h2>
							 </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Material</h4>
           ...
           <a href="listarcursosalumnos?name=<c:out value='${sessionScope.alumnos.name} ${sessionScope.alumnos.apellido}' />" class="btn btn-default" >
        ...
        <div class="modal-body">
          <div class="form-group">
			...
			value="<c:out value='${material.titulo}' />" class="form-control" name="titulo" disabled="disabled">
          </div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p> 
		<a download="<c:out value='${material.archivo}' />" href="maimagen/<c:out value='${material.archivo}' />" class="btn btn-sucess">
