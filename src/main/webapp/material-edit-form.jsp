    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <label>Archivo</label> <input type="text"
						value="<c:out value='${material.archivo}' />" class="form-control"
						name="archi" disabled="disabled">
          </div>
          ...
          <div class="form-group">
            <label>Clase</label> <input type="text"
						value="<c:out value='${material.nivel}' />" class="form-control"
						name="cla" disabled="disabled">
          </div>
          
          
          
          <div class="form-group">
            <p><label>Seleccionar Clases</label>
					<select id="nivel" name="nivel" class="form-control" required>
					
					<option selected="selected" disabled="disabled" value="">sin Clases</option>
					
					<c:forEach var="nivel" items="${listClasesC}">
					
					
						
						<option value="${material.id}" selected>${nivel.clase}</option>
          ...
          <div class="form-group">
            <label>materia</label> <input type="text"
						value="<c:out value='${material.materia}' />" class="form-control"
          ...
          <div class="form-group">
            <label>Alumnos</label> <input type="text"
						value="<c:out value='${material.name}' />" class="form-control"
          ...
          <div class="form-group">
            <p><label>Seleccionar Alumnos</label>
          ...
          <div class="form-group">
            <label>Temas</label> <input type="text"
						value="<c:out value='${material.tema}' />" class="form-control"
						name="alu" disabled="disabled">
          </div>
          ...
          <p><label>Seleccionar Temas</label>
					
					<select id="tema" name="tema" class="form-control" required="required">
...
<div class="modal fade" tabindex="-1" id="addArchivo" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
    <form action="eliminararchivomaterial" enctype="MULTIPART/FORM-DATA" method="post">
      ...
      <div class="modal-body">
        ...
        <img src="maimagen/<c:out value='${material.archivo}' />" width="470" height="350"/>
        
		 
		 
		<p> 
		<a href="eliminardatomaterial?archivo=<c:out value='${material.archivo}' />" class="btn btn-sucess">
