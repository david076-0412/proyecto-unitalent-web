		  ...
		  <!------top-navbar-end-----------> 
		   ...
		   <!------main-content-start-----------> 
		      ...
		      <div class="main-content">
					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Lista de Asistencias</h2>
							 </div>
				...
				<tbody>
					<!--   for (Todo todo: todos) {  -->
					<c:forEach var="asistencia" items="${listAsistencia}">
						...
						<tr>
							...
							<td><c:out value="${asistencia.nombre}" /></td>
							<td><c:out value="${asistencia.apellido}" /></td>
							<td><c:out value="${asistencia.clase}" /></td>
							<td><c:out value="${asistencia.materia}" /></td>
							<td><c:out value="${asistencia.seccion}" /></td>
							<td><c:out value="${asistencia.tipoasistencia}" /></td>
							<td><c:out value="${asistencia.fechade}" /></td>
							<td><c:out value="${asistencia.hora}" /></td>
							...
							<a href="editasistencia?id=${asistencia.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							...
							<a href="deleteasistencia?id=${asistencia.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
