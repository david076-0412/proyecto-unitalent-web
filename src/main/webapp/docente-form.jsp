    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          Añadir Nuevo Docente
           ...
           <a href="<%=request.getContextPath()%>/listdocentesadmin" class="btn btn-default" >
        ...
        <c:if test="${docentes != null}">
		<form action="updatedocenteadmin" method="post">
		</c:if>
		
		<c:if test="${docentes == null}">
		
		<form action="insertadocenteadmin" method="post">
		...
		<input type="hidden" name="id" value="${docentes.id}" />
          ...
          <div class="form-group">
			...
			value="<c:out value='${docentes.usuario}' />" class="form-control" name="usuario" required="required">
          </div>
          
          <div class="form-group">
           <label>Correo</label> <input type="text"
						value="<c:out value='${docentes.correo}' />" class="form-control"
          ...
          <div class="form-group">
            <label>Password</label> <input type="text"
						value="<c:out value='${docentes.clave}' />" class="form-control" 
          ...
          <div class="form-group">
            <label>Nombre</label> <input type="text"
						value="<c:out value='${docentes.nombre}' />" class="form-control" 
          ...
          <div class="form-group">
            <label>Apellido</label> <input type="text"
						value="<c:out value='${docentes.apellido}' />" class="form-control" 
						name="apellido" required="required">
          </div>
          
          <div class="form-group">
            <label>Direccion</label> <input type="text"
						value="<c:out value='${docentes.direccion}' />" class="form-control" 
						name="direccion" required>
          </div>
          
          
          
          <c:if test="${docentes.sexo != null}">
          
          
          <div class="form-group">
            <label>Sexo</label> <input type="text"
						value="<c:out value='${docentes.sexo}' />" class="form-control" disabled>
          </div>
          ...
          <c:if test="${docentes.fechadn != null}">
        
        
        <div class="form-group">
            <label>Fecha de Nacimiento</label> <input type="text"
						value="<c:out value='${docentes.fechadn}' />" class="form-control" 
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label>Telefono</label> <input type="text"
						value="<c:out value='${docentes.telefono}' />" class="form-control" 
          ...
          <div class="form-group">
            <label>Dni</label> <input type="text"
						value="<c:out value='${docentes.dni}' />" class="form-control" 
						name="dni" required>
          </div>
