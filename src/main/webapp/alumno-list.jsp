		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
			     <div class="row">
					 ...
					 <div class="col-md-5 col-lg-3 order-3 order-md-2">
					     <div class="xp-searchbar">
						     <form action="buscaralumnosadmin">
				 ...
				 <div class="xp-breadcrumbbar text-center">
					...
					<ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="listalumnosadmin">Alumnos</a></li>
					   ...
					   <div class="table-title">
					     <div class="row">
							 ...
							 <div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
							  ...
							  <a href="<%=request.getContextPath()%>/newalumnoadmin" class="btn btn-success">
				...
				<tbody>
					...
					<c:forEach var="alumno" items="${listUser}">
						...
						<tr>
							...
							<td><a href="editalumnoadmin?id=${alumno.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								
							
							
							<td>
							
							<a href="deletealumnoadmin?id=${alumno.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
