					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Lista de Material</h2>
							 </div>
				...
				<tbody>
					...
					<c:forEach var="material" items="${listCursos}">
						...
						<tr>
							...
							<a href="vermaterialtema?id=${material.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Read">&#xE8f4;</i></a>
							...
							<a href="editmaterial?id=${material.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							...
							<a href="eliminarmaterial?id=${material.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
