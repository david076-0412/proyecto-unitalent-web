					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Nueva Tarea</h2>
							 </div>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form action="inserttarea" class="formulario" id="formulario" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Puntos</label> 
			<input type="number" class="form-control" id="nota" name="nota" value="20" min="1" max="20" step="any" required="required">
          </div>
          ...
          <div class="form-group">
            <label>Fecha de Entrega</label> 
					...
					<input type="date"
						...
						value="<c:out value='<%=formatoFecha.format(fechaActual)%>'/>" 
          ...
          <div class="form-group">
            <label>Hora</label> 
					...
					<input type="time"
						class="form-control"
						id="hora" name="hora" value="<c:out value='<%=formatoHora.format(fechaActual)%>'/>" required="required">
          </div>
...
<div class="modal fade" tabindex="-1" id="addArchivo" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
    <form action="subirarchivotarea" enctype="MULTIPART/FORM-DATA" method="post">
