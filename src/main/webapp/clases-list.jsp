   ...
   <!-------sidebar--design- close----------->
      ...
      <div id="content">
		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
				 ...
				 <div class="xp-breadcrumbbar text-center">
					...
					<ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/listarclase">Cursos</a></li>
					   ...
					   <div class="table-title">
					     <div class="row">
							 ...
							 <div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
							  ...
							  <a href="<%=request.getContextPath()%>/newclase" class="btn btn-success">
							   ...
							   <span>Nueva Clase</span>
		  						...
		  						<a href="<%=request.getContextPath()%>/listarmaterial" class="btn btn-success">
		  						<i class="material-icons">&#xE147;</i>
       ...
       <thead>
				...
				<tbody>
					<!--   for (Todo todo: todos) {  -->
					<c:forEach var="clases" items="${listClases}">

						<tr>
							
							<td><c:out value="${clases.clase}" /> </td>
							
							<td><c:out value="${clases.seccion}" /></td>
							<td><c:out value="${clases.materia}" /></td>
							<td><c:out value="${clases.aula}" /></td>
							...
							<a href="verclase?id=${clases.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE8f4;</i></a>
							...
							<a href="editclase?id=${clases.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							...
							<a href="listartarea?id=${clases.id}" class="list"><i class="material-icons" data-toggle="tooltip" title="List">&#xE887;</i></a>
							...
							<a href="listarcalificacion?id=${clases.id}" class="list"><i class="material-icons" data-toggle="tooltip" title="List">&#xe85d;</i></a>
							...
							<a href="deleteclase?id=${clases.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
