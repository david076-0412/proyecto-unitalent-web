		  ...
		  <!------top-navbar-end-----------> 
		   ...
		   <!------main-content-start-----------> 
		      ...
		      <div class="main-content">
				...
				<tbody>
					<!--   for (Todo todo: todos) {  -->
					<c:forEach var="calificacion" items="${listUser}">

						<tr>
							
							<td><c:out value="${calificacion.titulo}" /></td>
							<td><c:out value="${calificacion.name}" /></td>
							<td><c:out value="${calificacion.nivel}" /></td>
							<td><c:out value="${calificacion.materia}" /></td>
							<td><c:out value="${calificacion.tema}" /></td>
							<td><c:out value="${calificacion.nota}" /></td>
							<td><c:out value="${calificacion.fechade}" /></td>
							
							
							
							
							<td><a href="editcalificacion?id=${calificacion.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								
							
							
							<td>
							
							<a href="eliminarcalificacion?id=${calificacion.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
