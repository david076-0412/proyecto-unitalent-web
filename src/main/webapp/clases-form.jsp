...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <c:if test="${clases != null}">
					<form action="updateclase" method="post">
				</c:if>
				<c:if test="${clases == null}">
        ...
        <c:if test="${clases != null}">
					<input type="hidden" name="id" value="<c:out value='${clases.id}' />" />
				</c:if>
        ...
        <div class="modal-body">
          <div class="form-group">
            <label>Nombre de la Clase</label> <input type="text"
						value="<c:out value='${clases.clase}' />" class="form-control"
						name="clase" required="required">
          </div>
          
          <div class="form-group">
          <label>Seccion</label> <input type="text"
						value="<c:out value='${clases.seccion}' />" class="form-control"
						name="seccion" required="required">
          </div>
          ...
          <div class="form-group">
            <label>Materia</label> <input type="text"
						value="<c:out value='${clases.materia}' />" class="form-control"
						name="materia" required="required">
          </div>
          ...
          <div class="form-group">
            <label>Aula</label> <input type="text"
						value="<c:out value='${clases.aula}' />" class="form-control"
						name="aula" required="required">
