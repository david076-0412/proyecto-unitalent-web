					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Lista de Tarea</h2>
							 </div>
					   ...
					   <table id="example" class="table table-striped table-hover" style="width:100%">
						  ...
						  <tbody>
							...
							<input type="hidden" name="id" value="${tarea.id}" />
							 <th><c:out value="${tarea.name}" /></th> 
							 
							 <th><c:out value="${tarea.titulo}" /></th>
							 
							 <th><c:out value="${tarea.descripcion}" /></th>
							 
							 <th><c:out value="${tarea.nivel}" /></th>
							 
							 <th><c:out value="${tarea.materia}" /></th>
							  
							 <th><c:out value="${tarea.tema}" /></th> 
							 
							 <th><c:out value="${tarea.nota}" /></th> 
							 
							 <th><c:out value="${tarea.fechade}" /></th> 
							 
							 <th><c:out value="${tarea.hora}" /></th>
							  
							 
							 <th>
							 <a href="calificacionalumnosvernota?id=${tarea.id}" class="edit">
