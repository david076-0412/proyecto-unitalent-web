...
@WebServlet("/materialalumnosver")
public class ServletMaterialAlumnosVer extends HttpServlet {
	...
	private void showVerForm(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("material-alumno-dashboard.jsp");
