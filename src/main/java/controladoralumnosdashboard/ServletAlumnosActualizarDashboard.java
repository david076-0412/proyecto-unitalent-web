...
@WebServlet("/updatealumnosdashboard")
public class ServletAlumnosActualizarDashboard extends HttpServlet {
	...
	private void updateUser(HttpServletRequest request, HttpServletResponse response) 
		...
		userDAO.updateUserPerfil(alumnos);
		
		

		
		alumnos = userDAO.selectUsers(id);
