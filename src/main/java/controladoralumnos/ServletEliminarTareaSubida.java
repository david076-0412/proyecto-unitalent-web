...
@WebServlet("/eliminararchivocalifica")
public class ServletEliminarTareaSubida extends HttpServlet {
	...
	private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        for(int i=0;i<items.size();i++){
            ...
            if (! item.isFormField()){
                ...
                File archivo_server = new File("http://localhost/WebEscuela/src/main/webapp/caimagen/"+item.getName());
